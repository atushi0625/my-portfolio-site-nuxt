<template>
  <header>
    <v-app-bar app dark>
      ...
      <v-tab><nuxt-link to="/skill">Skill</nuxt-link></v-tab>
      <v-tab><nuxt-link to="/works">Works</nuxt-link></v-tab>
    </v-app-bar>
    <!-- ここから -->
    <v-navigation-drawer v-model="drawer" fixed temporary color="#C62828" app>
      <v-list-item>
        <v-list-item-content>
          <v-list-item-title>Atushi Sato</v-list-item-title>
        </v-list-item-content>
      </v-list-item>
